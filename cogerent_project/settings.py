"""
Django settings for cogerent_project project.
"""
...
ROOT_URLCONF = 'cogerent_project.urls'
...
WSGI_APPLICATION = 'cogerent_project.wsgi.application'
...
# Redis comme broker et backend (surchargeable via REDIS_URL, ex. pour Docker)
...
# Session utilisant Redis (optionnel)
